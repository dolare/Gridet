 ...
 *
 * @uses shelley_header_style()
 * @uses shelley_admin_header_style()
 * @uses shelley_admin_header_image()
 */
function shelley_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'shelley_custom_header_args', array(
		'default-image'          => '',
		'default-text-color'     => '000000',
		'width'                  => 50,
		'height'                 => 50,
		'flex-height'            => true,
		'wp-head-callback'       => 'shelley_header_style',
		'admin-head-callback'    => 'shelley_admin_header_style',
		'admin-preview-callback' => 'shelley_admin_header_image',
	) ) );
}
add_action( 'after_setup_theme', 'shelley_custom_header_setup' );

if ( ! function_exists( 'shelley_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see shelley_custom_header_setup().
 */
function shelley_header_style() {
...
endif; // shelley_header_style

if ( ! function_exists( 'shelley_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see shelley_custom_header_setup().
 */
function shelley_admin_header_style() {
?>
	<style type="text/css">
...
endif; // shelley_admin_header_style

if ( ! function_exists( 'shelley_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see shelley_custom_header_setup().
 */
function shelley_admin_header_image() {
?>
	<div id="headimg">
...
endif; // shelley_admin_header_image
