  ...
  function IsEmail(email) {
	...
	var Institution   = obj.find("input#institution").val();
	var Email   = obj.find("input#email").val();
	var Message = obj.find("textarea#message").val();
	var sendto  = obj.find("input#sendto").val();
	Name    = Name.replace('Name','');
	Title    = Title.replace('Title','');
	Institution    = Institution.replace('Institution','');
   ...
   if( !IsEmail( Email ) ) {
	...
	obj.find(".noticefailed").append("<img alt='loading' class='loading' src='"+onetone_params.themeurl+"/images/loading.gif' />");
	 ...
	 jQuery.ajax({
				 ...
				 data:"Name="+Name+"&Title="+Title+"&Institution="+Institution+"&Email="+Email+"&Message="+Message+"&sendto="+sendto+"&action=onetone_contact",
