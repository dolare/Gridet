...
<div id="free_pro" class="rational-lite-tab-pane rational-lite-fre-pro">
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Well-documented','rational-lite' ); ?></h3>
                </td>
             ...
             <tr>
                <td>
                    <h3><?php esc_html_e( 'Fully Responsive Liquid Layout','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Translation Ready','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            ...
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Cross Browser Compatibility','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            ...
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Child Theme Compatible','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            ...
            <tr>
                <td>
                    <h3><?php esc_html_e( 'SketchBoard Framework','rational-lite' ); ?></h3>
                </td>
            ...
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Homepage With Shortable Section','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Unlimited Color Skins','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Persistent Header On/Off','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'About Section','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Our Team Section','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Team Member Boxes','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Testimonials Section','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Portfolio Section','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            ...
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Services Boxes','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            ...
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Contact Section','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Map Section','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            ...
            <tr>
                <td>
                    <h3><?php esc_html_e( '4 Post Format Support','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Video Slider','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( '4+ Custom Widgets','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Google Maps','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Tabs and Accordion','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'Video Shortcodes','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            <tr>
                <td>
                    <h3><?php esc_html_e( 'A Lot of Shortcodes','rational-lite' ); ?></h3>
                </td>
                <td><span class="dashicons-before dashicons-no-alt"></span></td>
                <td><span class="dashicons-before dashicons-yes"></span></td>
            </tr>
            ...
            <tr class="rational-lite-text-center">
                <td><a href="<?php echo esc_url( 'https://sketchthemes.com/premium-themes/one-page-wordpress-theme-for-business-and-digital-agencies/' ); ?>" target="_blank" class="button button-primary"><?php esc_html_e( 'Get Rational PRO now!','rational-lite' ); ?></a></td>
                <td><a href="<?php echo esc_url( 'http://trial.sketchthemes.com/wp-signup.php' ); ?>" target="_blank" class="button button-primary"><?php esc_html_e( 'Get Rational PRO Free Trial','rational-lite' ); ?></a></td>
            </tr>
        </tbody>
