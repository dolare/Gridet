...
Description: Official WordPress plugin for <em>Add to Homescreen</em> javascript widget. The plugin opens a call out on mobile phones inviting the user to add the website to the home screen. This plugin is developed by the same author of the javascript widget, so it is presumably the best way to get the latest updates and bug fixes.
Version: 1.1.3
